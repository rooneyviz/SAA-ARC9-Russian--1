...
SWEP.PrintName = "RPK-201"

SWEP.Description = [["A weapon in the rpk-200 line up of light machine guns based off of the rpk that fires 5.56x45 round ammunition ."]]
...
SWEP.ViewModel = "models/saa/weapons/arccw/akpack/rpk201/v_rpk201_v1.mdl"
...
SWEP.RangeMin = 10
SWEP.RangeMax = 12000*(813.1/305)
SWEP.ArmorPiercing = 0.815641245
SWEP.Penetration = 6.52512996
SWEP.DamageType = DMG_BULLET
SWEP.ShootEntity = nil
SWEP.PhysBulletMuzzleVelocity = (810/715)*3020-- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
