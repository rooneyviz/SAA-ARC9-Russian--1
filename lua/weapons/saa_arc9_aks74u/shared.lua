...
SWEP.ViewModel = "models/saa/weapons/arccw/akpack/aks74u/v_aks74u_v1.mdl"
...
SWEP.DamageMax = 29.8818037 -- 3 shot kill
SWEP.DamageMin =  8.96454111-- 5 shot kill
SWEP.RangeMin = 10
SWEP.RangeMax = 8117.12932
SWEP.ArmorPiercing = 0.75
SWEP.Penetration = 6
SWEP.DamageType = DMG_BULLET
SWEP.ShootEntity = nil
SWEP.PhysBulletMuzzleVelocity = 28967.4723-- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
...
SWEP.Attachments = {
    {
        ...
        Pos = Vector(0, 7.65*1.1, 0.35*1.1),
        Ang = Angle(0, -90, 0),
...
SWEP.DefaultBodygroups = "001001000000000"
...
name = "AKS-74U"
    local attached = self:GetElements()
if attached["saa_aksub_ribbedcover"] and attached["saa_muz_pbs4"] then name = "AKS-74UB"
        elseif attached["akmn_dovetail"] 
then name = "AKS-74UN"
    else name = "AKS-74U"
    end
