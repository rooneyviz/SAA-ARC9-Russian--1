...
SWEP.Description = [[Coming in with the Kalashnikov Century Program, the AK-105 offers the AK74's firepower and purpose to a compact package, featuring a shorter 12.4" barrel and a slightly greater rate of fire.]]
...
SWEP.DamageMax = 29 -- 3 shot kill
SWEP.DamageMin = 9 -- 5 shot kill
SWEP.RangeMin = 10
SWEP.RangeMax = 12000*(314/305)
SWEP.ArmorPiercing = 0.75
SWEP.Penetration = 6
SWEP.DamageType = DMG_BULLET
SWEP.ShootEntity = nil
SWEP.PhysBulletMuzzleVelocity = (806/715)*28150 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
