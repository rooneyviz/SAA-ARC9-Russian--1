...
SWEP.Description = [["Coming after the RPK, the RPK-74 is an other enhancement of the previous Kalashnikov light machine gun, sporting a smaller projectile boosting up range and rate of fire. Its optimised design makes it a top choice for even the most modern armies of the world."]]
...
SWEP.ViewModel = "models/saa/weapons/arccw/akpack/rpk74/v_rpk74_v1.mdl"
...
SWEP.RangeMin = 10
SWEP.RangeMax = 12000*(786/305)
SWEP.ArmorPiercing = 0.75
SWEP.Penetration = 6
SWEP.DamageType = DMG_BULLET
SWEP.ShootEntity = nil
SWEP.PhysBulletMuzzleVelocity = (1054/715)*28150 -- Physical bullet muzzle velocity in Hammer Units/second. 1 HU != 1 inch.
