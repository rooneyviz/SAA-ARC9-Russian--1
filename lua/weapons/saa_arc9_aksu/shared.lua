...
SWEP.Description = [[The AKMSU is the name attributed to a one off compact carbine derived from the Soviet AKM, chambered in 7.62×39mm. The carbine was commonly thought to be a Soviet prototype weapon, but evidence suggests that the carbine was not actually of Soviet origin, and was instead a custom-made weapon From the Khyber pass in pakistan misattributed as a Soviet weapon, only 1 was ever made.]]
...
SWEP.ViewModel = "models/saa/weapons/arccw/akpack/aksu/v_aksu_v2.mdl"
...
SWEP.Attachments = {
    ...
    {
        PrintName = "Barrel",
        Category = {"SAA_AK_BARREL"},
        Bone = "b_wpn",
        ExcludeElements = {"blockbarrel"},
        InstalledElements = {"20inches"},
...
name = "AKMSU"
    local attached = self:GetElements()
    if attached["saa_ak_762sbarrel"] then name = "AK104"
    else name = "AKMSU"
    end
