...
SWEP.Attachments = {
    ...
    {
        PrintName = "Barrel",
        Category = {"SAA_AK74_BARREL"},
        Bone = "b_wpn",
        ExcludeElements = {"blockbarrel"},
        InstalledElements = {"20inche"},
...
name = "AK-74"
    local attached = self:GetElements()
if attached["saa_ak_545sbarrel"] then name = "AK-105"
    elseif attached["saa_ak_545dbarrel"] then name = "Draco 5.45"
    elseif attached["aks74m_stock"] and attached["akmn_dovetail"] then name = "AK-74M"
